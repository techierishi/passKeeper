<template>
  <div>
    <mt-card title="AB AB " minTitle="AB AB AB AB AB ">
      <p class="f-500 c-black m-b-20">Bootstrap AB AB AB AB </p>
      <div class="btn-demo">
      ...
      <p class="f-500 c-black m-b-20">AB AB AB AB AB AB </p>
      ...
      <p class="f-500 c-black m-b-20">AB AB AB AB AB </p>
      ...
      <p class="f-500 c-black m-b-20">Disable AB AB AB AB AB </p>
      <div class="btn-demo">
    ...
    <mt-card title="Icon AB AB " minTitle="AB AB AB AB iconAB AB ">
      <p class="f-500 c-black m-b-20">Bootstrap AB AB AB AB </p>
      <div class="btn-demo">
    ...
    <mt-card title="AB AB AB " minTitle="AB AB AB AB AB AB AB AB ">
      <p class="f-500 c-black m-b-20">AB AB AB AB AB </p>
      <div class="btn-demo">
        <mt-button-group>
          <mt-button>AB AB </mt-button>
          <mt-button>AB AB </mt-button>
          <mt-button>AB AB </mt-button>
        </mt-button-group>
        <mt-button-group>
          <mt-button buttonType="primary">AB AB </mt-button>
          <mt-button buttonType="primary">AB AB </mt-button>
          <mt-button buttonType="primary">AB AB </mt-button>
        </mt-button-group>
        <mt-button-group>
          <mt-button buttonType="success">AB AB </mt-button>
          <mt-button buttonType="success">AB AB </mt-button>
          <mt-button buttonType="success">AB AB </mt-button>
        </mt-button-group>
        <mt-button-group>
          <mt-button buttonType="warning">AB AB </mt-button>
          <mt-button buttonType="warning">AB AB </mt-button>
          <mt-button buttonType="warning">AB AB </mt-button>
        </mt-button-group>
        <mt-button-group>
          <mt-button buttonType="danger">AB AB </mt-button>
          <mt-button buttonType="danger">AB AB </mt-button>
          <mt-button buttonType="danger">AB AB </mt-button>
        </mt-button-group>
      </div>
      <p class="f-500 c-black m-b-20">AB AB AB AB AB AB AB AB </p>
      <div class="btn-demo">
        <mt-button-group>
          <mt-button size="large">AB AB </mt-button>
          <mt-button size="large">AB AB </mt-button>
          <mt-button size="large">AB AB </mt-button>
        </mt-button-group>
        <mt-button-group>
          <mt-button buttonType="primary" size="large">AB AB </mt-button>
          <mt-button buttonType="primary" size="large">AB AB </mt-button>
          <mt-button buttonType="primary" size="large">AB AB </mt-button>
        </mt-button-group>
      </div>
      ...
      <div class="btn-demo">
        <mt-button-group>
          <mt-button size="small">AB AB </mt-button>
          <mt-button size="small">AB AB </mt-button>
          <mt-button size="small">AB AB </mt-button>
        </mt-button-group>
        <mt-button-group>
          <mt-button buttonType="primary" size="small">AB AB </mt-button>
          <mt-button buttonType="primary" size="small">AB AB </mt-button>
          <mt-button buttonType="primary" size="small">AB AB </mt-button>
        </mt-button-group>
      </div>
      <div class="btn-demo">
        <mt-button-group>
          <mt-button size="xsmall">AB AB </mt-button>
          <mt-button size="xsmall">AB AB </mt-button>
          <mt-button size="xsmall">AB AB </mt-button>
        </mt-button-group>
        <mt-button-group>
          <mt-button buttonType="primary" size="xsmall">AB AB </mt-button>
          <mt-button buttonType="primary" size="xsmall">AB AB </mt-button>
          <mt-button buttonType="primary" size="xsmall">AB AB </mt-button>
        </mt-button-group>
      </div>
